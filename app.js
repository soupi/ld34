...
(function(exports) {
                  ...
                  return Prelude.bind(Data_Maybe.bindMaybe)(Data_String.uncons(_19.tail))(function (_18) {
                      return Prelude.bind(Data_Maybe.bindMaybe)(Data_String.uncons(_18.tail))(function (_17) {
                          return Prelude.bind(Data_Maybe.bindMaybe)((function () {
                              ...
                              throw new Error("Failed pattern match at Machine line 188, column 1 - line 189, column 1: " + [ _36.constructor.name ]);
                          })())(function (_16) {
                              return Prelude.bind(Data_Maybe.bindMaybe)((function () {
                                  ...
                                  throw new Error("Failed pattern match at Machine line 188, column 1 - line 189, column 1: " + [ _39.constructor.name ]);
                              })())(function (_15) {
                                  return Prelude.bind(Data_Maybe.bindMaybe)((function () {
                                      ...
                                      throw new Error("Failed pattern match at Machine line 188, column 1 - line 189, column 1: " + [ _42.constructor.name ]);
                                  })())(function (_14) {
                                      return Prelude.bind(Data_Maybe.bindMaybe)((function () {
                                          ...
                                          throw new Error("Failed pattern match at Machine line 188, column 1 - line 189, column 1: " + [ _45.constructor.name ]);
                                      })())(function (_13) {
                                          return Prelude.bind(Data_Maybe.bindMaybe)((function () {
                                              ...
                                              throw new Error("Failed pattern match at Machine line 188, column 1 - line 189, column 1: " + [ _48.constructor.name ]);
                                          })())(function (_12) {
  ...
  var translate = function (txt) {
      ...
      if (_61.value0 === "100") {
          return Prelude["<$>"](Data_Either.functorEither)(PUSHVAL.create)(strBinToInt(_61.value1));
      };
  ...
  var movePC = function (machine) {
      ...
      if (_97 instanceof PUSHVAL) {
          return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))(moveBy(1))(machine));
      };
      if (_97 instanceof PUSHIN) {
          return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))(moveBy(1))(machine));
      };
      if (_97 instanceof POP) {
          return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))(moveBy(1))(machine));
      };
      if (_97 instanceof SKIP) {
      ...
      if (_97 instanceof SKIPIF) {
          return Data_Maybe.maybe(throwErr(StackUnderflow.value))(function (x) {
              return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))((function () {
                  ...
                  throw new Error("Failed pattern match at Machine line 109, column 1 - line 110, column 1: " + [ _99.constructor.name ]);
              })())(machine));
          })(Data_List.head(machine.stack));
      };
      ...
      throw new Error("Failed pattern match at Machine line 109, column 1 - line 110, column 1: " + [ _97.constructor.name ]);
  };
  var $$eval = function (machine) {
      return Control_Bind["=<<"](Data_Either.bindEither)(movePC)((function () {
          ...
          if (_100 instanceof SKIP) {
              return Prelude.pure(Data_Either.applicativeEither)(machine);
          };
          if (_100 instanceof SKIPIF) {
              return Prelude.pure(Data_Either.applicativeEither)(machine);
          };
          ...
          if (_100 instanceof COMPARE) {
              return Data_Maybe.maybe(throwErr(StackUnderflow.value))(function (_23) {
                  return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(stack(Data_Profunctor_Strong.strongFn))(Data_List.Cons.create((function () {
                      var _107 = _23.value0 === _23.value1;
                      if (_107) {
                          return 0;
                      };
                      if (!_107) {
                          var _108 = _23.value0 > _23.value1;
                          if (_108) {
                              return 1;
                          };
                          if (!_108) {
                      ...
                      throw new Error("Failed pattern match at Machine line 75, column 1 - line 76, column 1: " + [ _107.constructor.name ]);
                  })()))(machine));
              })(takeTwo(machine.stack));
          };
  ...
  var halted = function (machine) {
      var _111 = Zipper.current(machine.code);
      if (_111 instanceof HALT) {
          return true;
      };
      return Data_Either.isLeft($$eval(machine));
  };
  var hasErrors = function (machine) {
      var _112 = $$eval(machine);
      if (_112 instanceof Data_Either.Left) {
          return new Data_Maybe.Just(_112.value0);
      };
      if (_112 instanceof Data_Either.Right) {
          return Data_Maybe.Nothing.value;
      };
      throw new Error("Failed pattern match at Machine line 154, column 1 - line 155, column 1: " + [ _112.constructor.name ]);
  };
