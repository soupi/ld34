  ...
  var input = function __do() {
      ...
      return (function () {
          ...
          return function __do() {
              ...
              var _10 = io();
              var _9 = tKey();
              return Signal.sampleOn(_17)(Prelude["<*>"](Signal.applySignal)(Prelude["<*>"](Signal.applySignal)(Prelude["<*>"](Signal.applySignal)(Prelude["<*>"](Signal.applySignal)(Prelude["<*>"](Signal.applySignal)(Prelude["<*>"](Signal.applySignal)(Prelude["<*>"](Signal.applySignal)(Prelude["<*>"](Signal.applySignal)(Prelude["<$>"](Signal.functorSignal)(buildInput)(time))(_16))(_15))(once(_14)))(once(_13)))(_12))(_11))(_10))(_9));
          };
      })()();
  };
  exports["one"] = one;
...
(function(exports) {
  ...
  var takeTwo = function (_24) {
      if (_24 instanceof Data_List.Cons && _24.value1 instanceof Data_List.Cons) {
          return Data_Maybe.Just.create(new Utils.Tuple(_24.value0, _24.value1.value0));
      };
      return Data_Maybe.Nothing.value;
  };
                  ...
                  return Prelude.bind(Data_Maybe.bindMaybe)(Data_String.uncons(_19.tail))(function (_18) {
                      return Prelude.bind(Data_Maybe.bindMaybe)(Data_String.uncons(_18.tail))(function (_17) {
                          return Prelude.bind(Data_Maybe.bindMaybe)((function () {
                              var _36 = Prelude["=="](Prelude.eqChar)(_21.head)("0");
                              if (_36) {
                                  return new Data_Maybe.Just(1);
                              };
                              if (!_36) {
                                  var _37 = Prelude["=="](Prelude.eqChar)(_21.head)("1");
                                  if (_37) {
                                      return new Data_Maybe.Just(-1);
                                  };
                                  if (!_37) {
                              ...
                              throw new Error("Failed pattern match at Machine line 190, column 1 - line 191, column 1: " + [ _36.constructor.name ]);
                          })())(function (_16) {
                              return Prelude.bind(Data_Maybe.bindMaybe)((function () {
                                  var _39 = Prelude["=="](Prelude.eqChar)(_20.head)("0");
                                  if (_39) {
                                      return new Data_Maybe.Just(0);
                                  };
                                  if (!_39) {
                                      var _40 = Prelude["=="](Prelude.eqChar)(_20.head)("1");
                                      if (_40) {
                                          return new Data_Maybe.Just(1);
                                      };
                                      if (!_40) {
                                  ...
                                  throw new Error("Failed pattern match at Machine line 190, column 1 - line 191, column 1: " + [ _39.constructor.name ]);
                              })())(function (_15) {
                                  return Prelude.bind(Data_Maybe.bindMaybe)((function () {
                                      var _42 = Prelude["=="](Prelude.eqChar)(_19.head)("0");
                                      if (_42) {
                                          return new Data_Maybe.Just(0);
                                      };
                                      if (!_42) {
                                          var _43 = Prelude["=="](Prelude.eqChar)(_19.head)("1");
                                          if (_43) {
                                              return new Data_Maybe.Just(1);
                                          };
                                          if (!_43) {
                                      ...
                                      throw new Error("Failed pattern match at Machine line 190, column 1 - line 191, column 1: " + [ _42.constructor.name ]);
                                  })())(function (_14) {
                                      return Prelude.bind(Data_Maybe.bindMaybe)((function () {
                                          var _45 = Prelude["=="](Prelude.eqChar)(_18.head)("0");
                                          if (_45) {
                                              return new Data_Maybe.Just(0);
                                          };
                                          if (!_45) {
                                              var _46 = Prelude["=="](Prelude.eqChar)(_18.head)("1");
                                              if (_46) {
                                                  return new Data_Maybe.Just(1);
                                              };
                                              if (!_46) {
                                          ...
                                          throw new Error("Failed pattern match at Machine line 190, column 1 - line 191, column 1: " + [ _45.constructor.name ]);
                                      })())(function (_13) {
                                          return Prelude.bind(Data_Maybe.bindMaybe)((function () {
                                              var _48 = Prelude["=="](Prelude.eqChar)(_17.head)("0");
                                              if (_48) {
                                                  return new Data_Maybe.Just(0);
                                              };
                                              if (!_48) {
                                                  var _49 = Prelude["=="](Prelude.eqChar)(_17.head)("1");
                                                  if (_49) {
                                                      return new Data_Maybe.Just(1);
                                                  };
                                                  if (!_49) {
                                              ...
                                              throw new Error("Failed pattern match at Machine line 190, column 1 - line 191, column 1: " + [ _48.constructor.name ]);
                                          })())(function (_12) {
  ...
  var mkMachine = function (inst) {
      return function (input_1) {
          var _89 = Data_List.uncons(inst);
          if (_89 instanceof Data_Maybe.Nothing) {
              return Data_Maybe.Nothing.value;
          };
          if (_89 instanceof Data_Maybe.Just) {
              return new Data_Maybe.Just({
                  code: Zipper.zipper(_89.value0.head)(Data_List.Nil.value)(_89.value0.tail), 
                  stack: Data_List.Nil.value, 
                  input: input_1, 
                  output: Data_List.Nil.value
              });
          };
          throw new Error("Failed pattern match at Machine line 21, column 1 - line 22, column 1: " + [ _89.constructor.name ]);
      };
  };
  ...
  var movePC = function (machine) {
      var _97 = Zipper.current(machine.code);
      if (_97 instanceof HALT) {
          return Prelude.pure(Data_Either.applicativeEither)(machine);
      };
      if (_97 instanceof PRINT) {
      ...
      if (_97 instanceof LOADVAL) {
          return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))(moveBy(1))(machine));
      };
      if (_97 instanceof LOADIN) {
          return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))(moveBy(1))(machine));
      };
      if (_97 instanceof POP) {
          return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))(moveBy(1))(machine));
      };
      if (_97 instanceof JUMP) {
      ...
      if (_97 instanceof COMPARE) {
          return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))(moveBy(1))(machine));
      };
      if (_97 instanceof JUMPIF) {
          return Data_Maybe.maybe(throwErr(StackUnderflow.value))(function (x) {
              return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))((function () {
                  ...
                  throw new Error("Failed pattern match at Machine line 111, column 1 - line 112, column 1: " + [ _99.constructor.name ]);
              })())(machine));
          })(Data_List.head(machine.stack));
      };
      if (_97 instanceof ADD) {
          return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))(moveBy(1))(machine));
      };
      if (_97 instanceof EMPTY) {
          return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(code(Data_Profunctor_Strong.strongFn))(moveBy(1))(machine));
      };
      throw new Error("Failed pattern match at Machine line 111, column 1 - line 112, column 1: " + [ _97.constructor.name ]);
  };
      ...
      return Control_Bind["=<<"](Data_Either.bindEither)(movePC)((function () {
          ...
          if (_100 instanceof EMPTY) {
              return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(stack(Data_Profunctor_Strong.strongFn))(function (s) {
                  ...
                  throw new Error("Failed pattern match at Machine line 75, column 1 - line 76, column 1: " + [ _101.constructor.name ]);
              })(machine));
          };
          if (_100 instanceof LOADVAL) {
              return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(stack(Data_Profunctor_Strong.strongFn))(Data_List.Cons.create(_100.value0))(machine));
          };
          ...
          if (_100 instanceof ADD) {
              return Data_Maybe.maybe(throwErr(StackUnderflow.value))(function (_22) {
                  return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(stack(Data_Profunctor_Strong.strongFn))(Data_List.Cons.create((function () {
                      var _104 = (_22.value0 + _22.value1 | 0) > 31;
                      if (_104) {
                          return (_22.value0 + _22.value1 | 0) - 31;
                      };
                      if (!_104) {
                          var _105 = (_22.value0 + _22.value1 | 0) < -31;
                          if (_105) {
                              return 31 - (_22.value0 + _22.value1 | 0);
                          };
                          if (!_105) {
                      ...
                      throw new Error("Failed pattern match at Machine line 75, column 1 - line 76, column 1: " + [ _104.constructor.name ]);
                  })()))(machine));
          ...
          if (_100 instanceof COMPARE) {
              return Data_Maybe.maybe(throwErr(StackUnderflow.value))(function (_23) {
                  return Prelude.pure(Data_Either.applicativeEither)(Data_Lens_Setter.over(stack(Data_Profunctor_Strong.strongFn))(Data_List.Cons.create((function () {
                      var _109 = _23.value0 === _23.value1;
                      if (_109) {
                          return 0;
                      };
                      if (!_109) {
                          var _110 = _23.value0 > _23.value1;
                          if (_110) {
                              return 1;
                          };
                          if (!_110) {
                      ...
                      throw new Error("Failed pattern match at Machine line 75, column 1 - line 76, column 1: " + [ _109.constructor.name ]);
                  })()))(machine));
              })(takeTwo(machine.stack));
          };
          throw new Error("Failed pattern match at Machine line 75, column 1 - line 76, column 1: " + [ _100.constructor.name ]);
      })());
  };
  var halted = function (machine) {
      var _113 = Zipper.current(machine.code);
      if (_113 instanceof HALT) {
          return true;
      };
      return Data_Either.isLeft($$eval(machine));
  };
  var hasErrors = function (machine) {
      var _114 = $$eval(machine);
      if (_114 instanceof Data_Either.Left) {
          return new Data_Maybe.Just(_114.value0);
      };
      if (_114 instanceof Data_Either.Right) {
          return Data_Maybe.Nothing.value;
      };
      throw new Error("Failed pattern match at Machine line 156, column 1 - line 157, column 1: " + [ _114.constructor.name ]);
  };
