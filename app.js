...
(function(exports) {
  ...
  var asNum = function (b) {
      ...
      throw new Error("Failed pattern match at Input line 61, column 1 - line 61, column 30: " + [ b.constructor.name ]);
  };
  var screenDirection = function __do() {
      var _8 = Signal_DOM.keyPressed(enterKeyCode)();
      var _7 = Signal_DOM.keyPressed(backspaceKeyCode)();
  ...
  var arrows = function __do() {
      var _6 = Signal_DOM.keyPressed(leftKeyCode)();
      var _5 = Signal_DOM.keyPressed(rightKeyCode)();
      var _4 = Signal_DOM.keyPressed(upKeyCode)();
      var _3 = Signal_DOM.keyPressed(downKeyCode)();
  ...
  var input = function __do() {
      var _2 = Signal_DOM.animationFrame();
      return (function () {
          var time = Signal_Time.every(Signal_Time.millisecond * 17.0);
          return function __do() {
              var _1 = arrows();
              var _0 = screenDirection();
              return Prelude["<*>"](Signal.applySignal)(Prelude["<*>"](Signal.applySignal)(Prelude["<*>"](Signal.applySignal)(Prelude["<$>"](Signal.functorSignal)(buildInput)(time))(_1))(_0))(_2);
          };
      })()();
  };
  exports["asNum"] = asNum;
